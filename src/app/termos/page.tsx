    ...
    <div className="min-h-screen bg-slate-50 text-zinc-900 p-6">
      <div className="max-w-4xl mx-auto pt-20">
        ...
        <div className="space-y-8 text-zinc-700 text-sm">
          ...
          <section>
            <h2 className="text-2xl font-bold text-zinc-900 mb-4">3. Contas de Usuário</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-zinc-900 mb-4">4. Direitos de Propriedade Intelectual</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-zinc-900 mb-4">5. Descrição dos Produtos</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-zinc-900 mb-4">6. Política de Preços</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-zinc-900 mb-4">7. Política de Reembolso</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-zinc-900 mb-4">8. Limitação de Responsabilidade</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-zinc-900 mb-4">9. Alterações aos Termos</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-zinc-900 mb-4">10. Legislação Aplicável</h2>
            <p className="leading-relaxed">
