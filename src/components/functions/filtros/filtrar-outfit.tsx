...
export function FiltroOutfit({ categorias, tipos, onChange }: FiltroProps) {
  ...
  return (
    <section className="flex m-8 flex-col md:flex-row gap-4 mb-6" aria-labelledby="filtro-produtos">
      ...
      <div className="flex gap-2 flex-wrap mt-4 md:mt-0" aria-label="Filtrar por tipo de cosmético" role="group">
        <h3 className="text-xl font-medium mb-2">Tipo de Outfit</h3>
        {tipos.map((t) => (
          <button
            key={t}
